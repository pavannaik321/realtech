      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-gray-400 text-sm">
            <li>
              <a href="/index" className="hover:text-blue-400">
                Home
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/page" className="hover:text-blue-400">
                Contact
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            Phone: +91 7502137362, 8754753223
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-3">
            <a
              href="https://www.facebook.com/realtechcnc/"
              className="text-gray-400 hover:text-blue-400 text-xl"
            >
              <FaFacebookF />
            </a>
            <a
              href="https://www.youtube.com/@realtech5660"
              className="text-gray-400 hover:text-blue-400 text-xl"
            >
              <FaYoutube />
            </a>
            <a
              href="https://www.instagram.com/realtechvnb?igsh=MW0wb2g0anVmMjJyaw=="
              className="text-gray-400 hover:text-blue-400 text-xl"
            >
              <FaInstagram />
            </a>
            <a
              href="mailto:realtechvnb@gmail.com"
              className="text-gray-400 hover:text-blue-400 text-xl"
            >
              <FaEnvelope />
            </a>
